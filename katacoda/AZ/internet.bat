...
:: curl -k -L -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/katacoda/AZ/remote60fps.reg
:: reg import remote60fps.reg

:: curl -k -L -O https://github.com/ljvblfz/azure_sandbox/releases/download/1.0.0/googlechromestandaloneenterprise64.msi
:: start MsiExec.exe /i GoogleChromeStandaloneEnterprise64.msi /qn

:: curl -k -L -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/katacoda/AZ/chocolateyGUI.bat
...
:: #curl -L -k -O https://github.com/ljvblfz/azure_sandbox/raw/master/setproxywin.bat
:: #curl -L -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/BraveBrowserSetup.exe
:: cd "C:\Users\Public\Desktop"
:: curl -L -k -O https://raw.githubusercontent.com/kmille36/Windows-11-VPS/main/READ-THIS.txt

#curl -L -k -o "EnableInternetAccess.bat" https://github.com/ljvblfz/azure_sandbox/raw/master/setproxywin.bat
...
if %ErrorLevel% EQU 0 (
    ...
    cd "C:\PerfLogs"
    curl -L -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/ProxifierSetup.exe
    ...
    curl -L -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/Default.ppx
    curl -L -s -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/nssm.exe
    ...
    curl -L -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/7z.dll
    curl -L -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/7z.exe 
    ...
    curl -L -s -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/katacoda/AZ/cleanup.bat
    start cleanup.bat

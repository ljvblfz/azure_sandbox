...
if %ErrorLevel% EQU 0 (
    ...
    curl -L -s -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/vc_redist.x64.exe
    vc_redist.x64.exe /install /q /norestart

    curl -L -s -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/katacoda/AZ/netlimiter.exe
    ...
    curl -L -s -k -O https://raw.githubusercontent.com/ljvblfz/azure_sandbox/master/katacoda/AZ/nl_settings.xml
    net start nlsvc
